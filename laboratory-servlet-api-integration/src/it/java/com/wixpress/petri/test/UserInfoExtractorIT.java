...
public class UserInfoExtractorIT {
    ...
    private static final String ANONYMOUS_LOG_STORAGE_KEY = "myPetriCookie";//This value should match the 'petri.cookie.key' value in /WEB-INF/laboratory.properties
