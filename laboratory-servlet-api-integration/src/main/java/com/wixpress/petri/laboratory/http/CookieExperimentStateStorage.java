...
public class CookieExperimentStateStorage implements ExperimentStateStorage {
    ...
    public CookieExperimentStateStorage(HttpServletResponse response, String petriLogStorageCookieName) {
        this.response = response;
        this.petriLogStorageCookieName = petriLogStorageCookieName;
    }

    private String cookieKeyFor(UUID userId) {
        return petriLogStorageCookieName + "|" + userId;
    }
    ...
    public void storeAnonymousExperimentsLog(String experimentsLog) {
        storeExperimentsLog(petriLogStorageCookieName, experimentsLog);
    }
