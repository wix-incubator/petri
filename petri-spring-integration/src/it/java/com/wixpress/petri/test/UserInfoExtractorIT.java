...
public class UserInfoExtractorIT {
    ...
    public void getUserInfo() throws Exception {
        ...
        Map<String, Object> userInfo = extractUserInfoWithProperties(
                aPropertyList().withPair("user-agent", googleBotUserAgent).build(), extractUserInfoUrl);
    ...
    public void extractsExperimentsLogFromAnonymousCookie() throws Exception {
        ...
        Map<String, Object> userInfo =
                extractUserInfoWithProperties(
                        aPropertyList().withPair("Cookie", ANONYMOUS_LOG_STORAGE_KEY + "=" + experimentsLog).build(), extractUserInfoUrl);
    ...
    public void extractsEmptyExperimentLogsByDefault() throws Exception {
        Map<String, Object> userInfo = extractUserInfoWithProperties(NO_PROPERTIES, extractUserInfoUrl);
    ...
    public void extractsIpFromUserInfo() throws Exception {
        ...
        Map<String, Object> userInfo =
                extractUserInfoWithProperties(
                        aPropertyList().withPair("X-Forwarded-For", clientIp).build(), extractUserInfoUrl);
    ...
    public void extractsLanguageFromUserInfo() throws Exception {
        ...
        Map<String, Object> userInfo =
                extractUserInfoWithProperties(
                        aPropertyList().withPair("Accept-Language", languageTag).build(), extractUserInfoUrl);
    ...
    public void extractsCountryFromUserInfo() throws Exception {
        String country = "AF";
        Map<String, Object> userInfo =
                extractUserInfoWithProperties(aPropertyList().withPair("GEOIP_COUNTRY_CODE", country).build(), extractUserInfoUrl);
    ...
    public void extractsUserIdFromUserInfo() throws Exception {
        ...
        Map<String, Object> userInfo =
                extractUserInfoWithProperties(NO_PROPERTIES, extractUserInfoUrl + userIdUrl);
    ...
    public void extractsExperimentsOverrideFromUserInfo() throws Exception {
        ...
        Map<String, Object> userInfo = extractUserInfoWithProperties(NO_PROPERTIES, extractUserInfoUrl + overrideRequestUrl);
    ...
    private void assertWithDefaultValueForProperty(Map<String, Object> userInfo, String propertyName, Object expectedValue, Object expectedDefaultValue) throws IOException {
        ...
        Map<String, Object> defaultUserInfo = extractUserInfoWithProperties(NO_PROPERTIES, extractUserInfoUrl);
        assertThat(defaultUserInfo.toString(), defaultUserInfo.get(propertyName), CoreMatchers.is(expectedDefaultValue));
    }

    private Map<String, Object> extractUserInfoWithProperties(List<Pair<String, String>> properties, String extractUserInfoUrl) throws IOException {
    ...
    private scala.collection.immutable.Map.Map1<String,String> aExperimentOverrides(String key, String value){
        return new scala.collection.immutable.Map.Map1<String, String>(key, value);
    }
